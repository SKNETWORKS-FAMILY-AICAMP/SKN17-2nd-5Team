...
<table align="center" width="100%">
  ...
  <tr>
    <td align="center"><img src="./images/hh3.jpg" width="100px" /></td>
...
- 해당 범주에 속하는 결측치 수는 Languge의 결측치 수와 동일.
...
Cramér's V: 0.2710
```
➡ 결제 플랫폼별 상대적으로 이탈률의 차이가 있고, 통계적으로도 유의미한 관련성을 보임
...
- 해당 파라미터를 기반으로, 모델 성능을 더욱 고도화하기 위해 **추가적인 수동 하이퍼파라미터 및 임계치(Threshold) 조정**

- 그 결과 성능이 유의미하게 향상됨을 확인
...
모델 성능 고도화 과정에서 유의미한 성능 향상을 확인. 이는 다양한 하이퍼파라미터 조합을 탐색함으로써 모델의 성능을 더욱 개선할 수 있음을 시사. 다만, 시간적 제약으로 인해 충분한 조합을 실험하지 못하였으며, 특히 SVM의 경우 약 900분이 소요되어 테스트 범위가 제한되었음.
